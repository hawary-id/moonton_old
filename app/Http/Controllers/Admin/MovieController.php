...
class MovieController extends Controller
{
    ...
    {
        $data = $request->all();
        if($request->file('thumbnuil')){
            $data['thumbnail'] = Storage::disk('public')->put('movies',$request->filr('thumbnail'));
    ...
    public function destroy(Movie $movie)
    {
        $movie->delete();
        return redirect(route('admin.dashboard.movie.index'))->with([
            'message' => 'Movie deleterd successfully',
            'type' => 'success'
        ]);
    }
